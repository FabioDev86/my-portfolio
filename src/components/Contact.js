...
export default function Contact(){
    ...
    let alert_msg;
    switch(language){
        case "english" :    text = [data.contacts_text.header.english, data.contacts_text.name_label.english, data.contacts_text.email_label.english, data.contacts_text.message_label.english, data.contacts_text.button.english ]; 
                            ...
                            break;
        case "italiano" :   text = [data.contacts_text.header.italiano, data.contacts_text.name_label.italiano, data.contacts_text.email_label.italiano, data.contacts_text.message_label.italiano, data.contacts_text.button.italiano]; 
                            ...
                            break;
        case "deutsch" :    text = [data.contacts_text.header.deutsch, data.contacts_text.name_label.deutsch, data.contacts_text.email_label.deutsch, data.contacts_text.message_label.deutsch, data.contacts_text.button.deutch];
            ...
            >
                ...
                <Form>
                    ...
                    <MyTextArea 
                        ...
                        type="textarea"
                    />
                    <button type="submit" id="submit">{text[4]}</button>
                </Form>
